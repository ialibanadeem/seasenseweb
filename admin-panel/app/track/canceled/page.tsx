...
const CANCELED_DATA = [
    { id: 'ORD-2345', item: 'Glass Panels', customer: 'ClearView', date: 'Oct 10, 2025', by: 'Customer' },
];

export default function TrackCanceledPage() {
    return (
        <div className="flex w-full h-full p-8 gap-8 bg-[#fafbfc]">
            <div className="flex-1 flex flex-col max-w-[1000px] w-full mx-auto">
                <div className="flex justify-between items-start mb-8">
                    <div>
                        <h1 className="text-[28px] font-bold text-slate-900 tracking-tight">Canceled Shipments</h1>
                        <p className="text-[15px] font-medium text-slate-500 mt-2">Log of all canceled or rejected orders.</p>
                    </div>
                </div>

                <div className="bg-white rounded-2xl flex flex-col border border-slate-200 shadow-sm flex-1">
                    <div className="px-6 py-4">
                        <div className="grid grid-cols-12 gap-4 px-4 py-3 bg-red-50/50 rounded-xl mb-3 text-[13px] font-bold text-red-500 border border-red-100/50">
                            <div className="col-span-3">Order ID</div>
                            <div className="col-span-3">Item Name</div>
                            <div className="col-span-2">Customer</div>
                            <div className="col-span-2">Cancel Date</div>
                            <div className="col-span-2">Requested By</div>
                        </div>

                        <div className="flex flex-col gap-1">
                            {CANCELED_DATA.map(order => (
